    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
          <dd><a href="${pageContext.request.contextPath }/view/system/Skill/SkillIndex.jsp" style="color:rgb(6,218,255)">任务列表</a></dd>
            <dd><a href="${pageContext.request.contextPath }/view/system/Skill/SkillTaskDone.jsp">已完成</a></dd>
...
layui.use('table', function(){
  ...
  table.render({
    elem: '#test'
    ,url:'<c:url value="/anomaly/data?s=2"/>'
