    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item" ><a href="${pageContext.request.contextPath }/view/system/admin/AdminAbnormal.jsp" >异常情况</a></li>
      	<li class="layui-nav-item"><a  href="${pageContext.request.contextPath }/view/system/admin/AdminFacilities.jsp" style="color:rgb(6,218,255)">公共设施</a></li>
      </ul>
    </div>
  </div>
  
  <div class="layui-body">
    <form action="${pageContext.request.contextPath }/facilities/editFacilities" class="layui-form" method="post" enctype="multipart/form-data"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input type="text" name="facilitiesname" value="${facilities.facilitiesname }"  placeholder="请输入用户名" autocomplete="off" class="layui-input">
				    </div>
				  </div>
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input type="text" name="status" value="${facilities.status }"  placeholder="请输入状态" autocomplete="off" class="layui-input">
				    </div>
				  </div>
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input type="text" name="area" value="${facilities.area }"  placeholder="请输入地点" autocomplete="off" class="layui-input">
				    </div>
				  </div>
				  	 ...
				  	 <div class="layui-form-item">
						    ...
						    <div class="layui-input-block">
						      <input type="text" name="uploadtime" value="${facilities.uploadtime }" id="test1" placeholder="请输入上传时间" required="required"
								 class="layui-input">
						    </div>
				  	</div>
