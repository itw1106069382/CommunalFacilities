...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    <form action="${pageContext.request.contextPath }/facilities/saveFacilities" class="layui-form" method="post" enctype="multipart/form-data"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
				  ...
				  <div class="layui-form-item">
					...
					<select name="username">
						...
						<c:forEach items="${userList}" var="userDir">
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input type="text" name="facilitiesname" value="" placeholder="请输入设施" autocomplete="off" class="layui-input">
				    </div>
				  </div>
				    ...
				    <div class="layui-input-block">
				      	<input type="text" name="area" value="" placeholder="请输入地点" autocomplete="off" class="layui-input">
				    	</div>
				  	</div>
