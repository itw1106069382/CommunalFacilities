...
<li class="layui-nav-item"><a href="${pageContext.request.contextPath }/view/system/admin/AdminFacilities.jsp" style="color:rgb(6,218,255)">公共设施</a></li>      </ul>
  ...
  <div class="layui-body">
    ...
    <div style="padding: 0px;" class="layui-anim" data-anim="layui-anim-up" >
		  ...
		  <form class="layui-form layui-form-pane"  id="searchFrm" lay-filter="searchFrm" method="post" action="">
		  	<div class="layui-form-item">
		  		<div class="layui-inline">
				    ...
				    <div class="layui-input-inline">
				      <input type="text" name="area" lay-verify="title"  autocomplete="off" placeholder="请输入地点" class="layui-input">
	   				 </div>
		  		</div>
		  		<div class="layui-form-item">
				    <div class="layui-input-block" style="margin-left: 280px;">
				      <button class="layui-btn" lay-submit id="doSearch" lay-filter="doSearch" ><span class="layui-icon layui-icon-search"></span>查询</button>
...
layui.use(['table','laypage','form'], function(){
 ...
 var tableIns = table.render({
    ...
    ,cols: [[
      ...
      ,{field:'operate',width:110,title:'操作',toolbar: '#barDemo'}
    ]]
    ,page: true //开启分页
    ,limit : 10
    ,limits:[5,10,15,20]
          ...
          form.on('submit(doSearch)', function(data){
            ...
            table.reload('test', {
               where: {//这里传参  向后台
                ...
                ,limits:[5,10,15,20]
            	, page: true
                , url: '<c:url value="/facilities/findSeek"/>'//后台做模糊搜索接口路径
                , method: 'post'
               	,parseData: function(res){ //res 即为原始返回的数据
                   	return{
                   	"code": res.code
