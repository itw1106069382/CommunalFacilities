...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    <form action="${pageContext.request.contextPath }/flows/editFlows" class="layui-form" method="post" enctype="multipart/form-data"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input type="text" name="username" value="${flows.username }" readonly="readonly" placeholder="请输入用户名" autocomplete="off" class="layui-input">
				    </div>
				  </div>
				    ...
				    <div class="layui-input-block">
				  	...
				  	<div class="layui-form-item">
						    ...
						    <div class="layui-input-block">
						      <input type="text" name="flowTime" id="test1" required="required"
