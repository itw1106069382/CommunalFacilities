...
<head>
  ...
  <link rel="stylesheet" href="<%=basePath %>/res/bootstrap/css/bootstrap.css" media="all">
	...
	<style type="text/css">
		...
		<div id="heading">&nbsp;</div>
		<div id="container">
			<form class="layui-form" action="${pageContext.request.contextPath }/user/updateUserPassword"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="password" name="password1" placeholder="请确认密码" autocomplete="off" class="layui-input">
