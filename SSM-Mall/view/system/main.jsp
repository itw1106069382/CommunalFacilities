...
<body>
	<h1>
		<span class="action-span1"><a href="#">ECSHOP 管理中心</a> </span> <span
	...
	<div class="list-div">
		<table cellspacing='1' cellpadding='3'>
			...
			<tr>
				<td width="20%"><a href="#">待发货订单:</a>
				</td>
				<td width="30%"><strong style="color:red">4</strong>
				</td>
				<td width="20%"><a href="#">未确认订单:</a>
				</td>
				<td width="30%"><strong>2</strong>
				</td>
			</tr>
			<tr>
				<td><a href="#">待支付订单:</a>
	...
	<div class="list-div">
		<table cellspacing='1' cellpadding='3'>
			...
			<tr>
				<td width="20%">商品总数:</td>
				<td width="30%"><strong>20</strong>
				</td>
				<td width="20%"><a href="#">库存警告商品数:</a>
				</td>
				<td width="30%"><strong style="color:red">7</strong>
				</td>
			</tr>
			<tr>
				<td><a href="#">新品推荐数:</a>
