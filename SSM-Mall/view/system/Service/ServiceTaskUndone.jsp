    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
          <dd><a href="${pageContext.request.contextPath }/view/system/Service/ServiceIndex.jsp" >任务列表</a></dd>
            <dd><a href="${pageContext.request.contextPath }/view/system/Service/ServiceTaskDone.jsp" >已处理</a></dd>
            <dd><a href="${pageContext.request.contextPath }/view/system/Service/ServiceTaskUndone.jsp" style="color:rgb(6,218,255)">未处理</a></dd>
          </dl>
        </li>
      </ul>
    </div>
...
layui.use('table', function(){
  ...
  table.render({
    elem: '#test'
    ,url:'<c:url value="/anomaly/data?s=5"/>'
...
//编辑
  function edit(data){
	  ...
	  //alert(rows)
		...
		window.top.location.href = '<c:url value="/anomaly/getAnomalyById"/>' + '?id=' + rows.data[0].id+'&s='+2;
  }
});
</script>
</body>
